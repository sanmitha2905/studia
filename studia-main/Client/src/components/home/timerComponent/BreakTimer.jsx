    ...
    <div className="text-center flex flex-col items-center justify-center h-full">
      ...
      <div className="flex gap-4 justify-center mt-4">
        <Button
          ...
          variant="default"
          size="default"
          className={`relative px-6 py-2 rounded-lg flex items-center gap-2 transition-colors duration-300 ease-in-out ${isRunning ? "bg-black/20 hover:bg-black/30 text-txt" : ""}`}
        >
          <span
