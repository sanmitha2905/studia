                    ...
                    {editingEvent === event._id ? (
                      <div className="space-y-2">
                        <input
                          ...
                          className="w-full rounded-lg bg-transparent border border-[var(--bg-ter)] px-3 py-2 txt placeholder:txt-dim focus:outline-none focus:ring-2 focus:ring-red-500 transition text-sm"
                        ...
                        <div className="flex gap-2">
                          <input
                            ...
                            className="flex-1 rounded-lg bg-transparent border border-[var(--bg-ter)] px-3 py-2 txt focus:outline-none focus:ring-2 focus:ring-red-500 transition text-sm"
                          />
                          <input
                            type="time"
                            value={editTime}
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-1">
                          <Button
                            ...
                            variant="transparent"
                            size="icon"
                            className="p-2 txt-dim hover:text-txt-red transition-colors"
                          >
